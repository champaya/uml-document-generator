...
# Instructions
出力された入力コードをPlantUMLの状態遷移図デザインドキュメントとして出力してください。
...
state Setup_Component {
  ...
  Initialize --> Fetch_Items : 授業データ取得
  Fetch_Items --> Set_Items : itemsでデータ設定
  
  note right of Fetch_Items
    非同期処理: API呼び出し
  end note

  Set_Items --> Fetch_Timetables : 時間割データ取得
  Fetch_Timetables --> Set_Timetables : timetableでデータ設定
